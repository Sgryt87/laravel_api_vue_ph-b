...
<script>
    export default {
        ...
        methods: {
            ...
            save: function () {
                axios.post('http://localhost:8888/MY/phonebook_lar_vue/public/phonebook', this.$data.list)
                    .then((response) => {
                        this.close();
                        ...
                        //empty out the list after adding a name, preventing data dulication in inpouts
                        this.list = '';
                    })
